...
trait CogenInstances {
  ...
  implicit val catsContravariantSemigroupalInstanceForScalacheckCogen: ContravariantSemigroupal[
    Cogen] =
  ...
  implicit val catsMonoidKInstanceForScalacheckCogen: MonoidK[Cogen] =
    new MonoidK[Cogen] {
      def empty[A]: Cogen[A] =
        Cogen { (seed, _) =>
          seed
